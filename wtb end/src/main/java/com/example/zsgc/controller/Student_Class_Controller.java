...
public class Student_Class_Controller {
    ...
    public List<Student_Class> selectByStudent(@RequestBody Student_Class student_class) {
        return student_class_mapper.selectByStudent(student_class);
    }

    @RequestMapping(value = {"/selectByAclass"}, method = RequestMethod.POST)
    public List<Student_Class> selectByAclass(@RequestBody Student_Class student_class) {
        return student_class_mapper.selectByAclass(student_class);
    }

    @RequestMapping(value = {"/selectByPosition"}, method = RequestMethod.POST)
    public List<Student_Class> selectByPosition(@RequestBody Student_Class student_class) {
        return student_class_mapper.selectByPosition(student_class);
    }

    @RequestMapping(value = {"/insert"}, method = RequestMethod.POST)
    public void insertStudent_Class(@RequestBody Student_Class student_class) {
        student_class_mapper.insertStudent_Class(student_class);
    }

    @RequestMapping(value = {"/update"}, method = RequestMethod.PUT)
    public void updateStudent_Class(@RequestBody Student_Class student_class) {
        student_class_mapper.updateStudent_Class(student_class);
    }

    @RequestMapping(value = {"/delete"}, method = RequestMethod.POST)
    public void deleteStudent_Class(@RequestBody Student_Class student_class) {
