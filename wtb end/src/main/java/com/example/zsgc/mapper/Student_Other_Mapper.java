...
public interface Student_Other_Mapper {
    ...
    public void insertStudent_Association(Student_Other student_association);

    @Update("update student_association set 职位=#{position} where 学号=#{student} and 社团名称=#{association}" )
    public void updateStudent_Association(Student_Other student_association);

    @Delete("delete from student_association where 学号=#{student} and 社团名称=#{association}")
    public void deleteStudent_Association(Student_Other student_association);
}
