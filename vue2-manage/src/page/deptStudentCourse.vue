    ...
    <div class="fillcontain">
        ...
        <div class="table_container">
                ...
                <el-table-column label="操作" width="160">
                    <template slot-scope="scope">
                        ...
                        <el-button
                            size="small"
                            type="danger"
                            @click="deletenb(scope.row.studentId,scope.row.courseId)">删除
                        </el-button>
                    </template>
                </el-table-column>
            </el-table>
            ...
            <div style="text-align:center">
                <el-button @click="handleEdit(-1)">添加学生课程关系</el-button>
            </div>
            <el-dialog title="修改学生选课信息" v-model="dialogFormVisible">
                <el-form :model="selectTable">
                    ...
                    <el-form-item label="课程号" label-width="100px">
                        <el-input v-model="selectTable.courseId"></el-input>
                    </el-form-item>
...
export default {
    ...
    methods: {
        ...
        deletenb(name1,name2) {
            this.$axios
                .post('/studentcourse/delete', {student: name1,course: name2})
                .then(successResponse => {
                    //console.log(successResponse);
