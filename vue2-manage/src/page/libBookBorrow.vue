    ...
    <div class="borrow fillcontain">
        ...
        <div class="table_container">
                ...
                <el-table-column label="操作" width="160">
                    <template slot-scope="scope">
                        ...
                        <el-button
                            size="small"
                            type="danger"
                            @click="deletenb(scope.row.studentId,scope.row.bookId)">删除</el-button>
                    </template>
                </el-table-column>
            </el-table>
            ...
            <div  style="text-align:center">
                <el-button class="el-icon-plus"  @click="handleEdit(-1)">添加借阅关系</el-button>
            </div>
            <el-dialog title="添加/修改借阅信息" v-model="dialogFormVisible">
                <el-form :model="selectTable">
                    ...
                    <el-form-item label="图书编号" label-width="100px">
                        <el-input v-model="selectTable.bookId"></el-input>
                    </el-form-item>
                    <el-form-item label="借阅时间" label-width="100px">
                        <el-input v-model="selectTable.borrowTime"></el-input>
                    </el-form-item>
...
export default {
    ...
    methods: {
        ...
        showAll() {
            ...
            for(i=l;i<r&&i<len;i++)
            {
                this.tableData.push({
                    ...
                    bookId: this.allData[i].book,
                    borrowTime: this.allData[i].borrowDate,
        ...
        insert() {
            ...
            this.$axios
                .post('/studentbook/insert', {
                    ...
                    borrowDate: this.selectTable.borrowTime,
                    state: this.selectTable.bookStatus}
                )
                .then(successResponse => {
                    //console.log(successResponse);
                    this.$message({type: 'success',message: '添加借阅信息成功'});
                    this.selectAll();
                })
                .catch(failResponse => {
                    this.$message({type: 'error',message: '添加借阅信息失败'});
                    this.showAll();
                })
        },
        update() {
            ...
            this.$axios
                ...
                .then(successResponse => {
                    //console.log(successResponse);
                    this.$message({type: 'success',message: '更新借阅信息成功'});
                    this.selectAll();
                })
                .catch(failResponse => {
        ...
        deletenb(name1,name2) {
            this.$axios
                .post('/studentbook/delete', {student: name1,book: name2})
                .then(successResponse => {
                    //console.log(successResponse);
