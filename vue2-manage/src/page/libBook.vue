<template>
    <div class="fillcontain">
        ...
        <div class="table_container">
                ...
                <el-table-column label="操作" width="160">
                    <template slot-scope="scope">
                        ...
                        <el-button
                            size="small"
                            type="danger"
                            @click="deletenb(scope.row.bookId)">删除
                        </el-button>
                    </template>
                </el-table-column>
            </el-table>
            ...
            <el-dialog title="添加/修改书籍信息" v-model="dialogFormVisible">
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            searchClick() {
                this.$axios
                    .post('/book/selectByIdOrName', {
                        bookId: "%" + this.keywords + "%",
                        name: "%" + this.keywords + "%"
                    })
