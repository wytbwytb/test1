    ...
    <div class="fillcontain">
        ...
        <div class="table_container">
            ...
            <div style="text-align:center">
                <el-button @click="handleEdit()">添加课程书籍关系</el-button>
            </div>
            <el-dialog title="修改课程书籍信息" v-model="dialogFormVisible">
                <el-form :model="selectTable">
                    <el-form-item label="课程号" label-width="100px">
                        <el-input v-model="selectTable.courseId" auto-complete="off"></el-input>
                    </el-form-item>
                    <el-form-item label="书目类型" label-width="100px">
                        <el-input v-model="selectTable.bookType"></el-input>
                    </el-form-item>
                    ...
                    <el-form-item label="作者" label-width="100px">
                        <el-input v-model="selectTable.Writer"></el-input>
                    </el-form-item>
                </el-form>
